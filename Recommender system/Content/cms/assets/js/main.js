...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "/Content/cms/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "/Content/cms/themes/" + selectedTheme + ".css");
		...
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "/Content/cms/themes/theme-1.css");
			$(".navbar-brand img").attr("src", "assets/images/logo.png");
