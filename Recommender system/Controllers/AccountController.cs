...
using Recommender_system.Helpers;
    ...
    public class AccountController : BaseController
    {
                ...
                case SignInStatus.RequiresVerification:
                    {
                        ...
                        ViewBag.UserIDCode = userdb.ID;
                        return View("VerifyCodeSent");
                    } 
        ...
        public async Task<SignInStatus> PasswordSignIn(string userName, string password, bool isPersistent, bool shouldLockout)
        {
            ...
            if (await UserManager.CheckPasswordAsync(user, password))
            {
                ...
                {
                    AuthenticationManager.SignIn(new AuthenticationProperties() { ExpiresUtc = new DateTimeOffset(DateTime.UtcNow.AddMinutes(20)) }, userIdentity);
                }
        ...
        public async Task<ActionResult> UserRegister_Post(RegisterViewModelUser model)
        {
            ...
            if (true)
            {
                if (ModelState.IsValid)
                {
                    ...
                    var user = new ApplicationUser { UserName = username, Email = model.EmailAdresa };
